// 3_IsolatingIndividualTestRunning.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
#include <iostream>
#include <string>
#include <map>
...
void TestAll() {
    try {
        ...
        cout << "TestCount fails: " << ex.what() << endl;
    }
    ...
    try {
        ...
        cout << "TestAreSynonyms fails: " << ex.what() << endl;
    }
    try {
        TestAddSynonyms();
    }
    catch (const runtime_error& ex) {
        cout << "TestAddSynonyms fails: " << ex.what() << endl;
    }
}
...
void RunTest(TestFunc func, const string& test_name) {
    try {
        ...
        cout << test_name << " fails: " << ex.what() << endl;
    }
}
